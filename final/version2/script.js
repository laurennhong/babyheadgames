	...
	*/
	...
	function checkWinningCondition() {
		if (gameData.score[gameData.index] > gameData.gameEnd) {
			if (gameData.index == 1) {
				actionArea.innerHTML = `<h2>${gameData.players[gameData.index]} 
				wins with ${gameData.score[gameData.index]} points!</h2><br><img src="images/girl2Winner.gif" alt="girl2winner" width="400">`;
			} else {
				actionArea.innerHTML = `<h2>${gameData.players[gameData.index]} 
				wins with ${gameData.score[gameData.index]} points!</h2><br><img src="images/girl1Winner.gif" alt="girl1winner" width="400">`;
			}

			document.getElementById('game').innerHTML = '';
			document.getElementById('started').innerHTML = 'Game Finished!';
			document.getElementById('quit').innerHTML = 'Start a New Game?';
			gameControl.style.opacity = "1";
		} else {
			// show current score...
			showCurrentScore();
		}
